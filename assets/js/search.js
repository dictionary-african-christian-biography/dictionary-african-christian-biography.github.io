...
function processData() {
    ...
    return function(data) {
        ...
        $.each(data, function(index, item) {
            // check if search term is in content or title or author or tags or alternate
            if (item.search_omit != "true" && (item.content.toLowerCase().indexOf(q.toLowerCase()) > -1 || item.author.toLowerCase().indexOf(q.toLowerCase()) > -1 || item.alternate.toLowerCase().indexOf(q.toLowerCase()) > -1 || item.author.toLowerCase().indexOf(q.toLowerCase()) > -1 || item.category.toLowerCase().indexOf(q.toLowerCase()) > -1 || item.title.toLowerCase().indexOf(q.toLowerCase()) > -1)) {
